...
export default class ImageHelper {
     ...
     */
    public addImageDescriptionToFile(filePath: string, fileName: string, content: string) {
        var thisRelPath = path.join(filePath, fileName);
     ...
     * @returns Array of objects of files. The objects have the structure {fileName:'', folderPath:'', completePath:''}
     */
    ...
    public generateSelectImagesOptionsHTML(files:any){
        ...
        files.forEach(fileObject => {
            ...
            returnString += `<option datafolderpath='${fileObject.folderPath}' datafullpath='${fileObject.completePath}' datarelativepath='${fileObject.relativePath}' value='${markdownReadyRelativePath}'>${fileObject.fileName}</option>`;
