...
export default class Helper {
     ...
     */
    public getCurrentTextEditor(): vscode.TextEditor | null {
    ...
    public isSelectionEmpty(): boolean {
        const editor = this.getCurrentTextEditor();
        if (!editor) {
            console.log("no edtior 2 ");
            return true;
        }
